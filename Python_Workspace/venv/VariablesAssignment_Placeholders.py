...
Developer = Tester = Devops = 50000.00
...
print("Age: %d \nSal: %d" % (Age, Sal))
print("Ages of Niha, Chandu, Nikki are %d, %d, %d respectively" % (Niha, Chandu, Nikki))
print("The salary of %s is %d" % (Job_Description, Salary))
